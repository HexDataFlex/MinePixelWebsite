...
/* Smarty version 4.2.0, created on 2022-08-31 14:42:03
  from '/srv/http/MinePixelWebsite/custom/templates/DefaultRevamp/profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_630f652b772443_35063720',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2df376e711118b4a1ba52259bfefa0b197687d9b' => 
    array (
      0 => '/srv/http/MinePixelWebsite/custom/templates/DefaultRevamp/profile.tpl',
      1 => 1661950942,
      2 => 'file',
    ),
  ),
...
function content_630f652b772443_35063720 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/srv/http/MinePixelWebsite/vendor/smarty/smarty/libs/plugins/modifier.regex_replace.php','function'=>'smarty_modifier_regex_replace',),1=>array('file'=>'/srv/http/MinePixelWebsite/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),));
$_smarty_tpl->_subTemplateRender('file:header.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
$_smarty_tpl->_subTemplateRender('file:navbar.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

<div class="ui segment center aligned" id="profile-header"
    style="background-image:url('<?php echo $_smarty_tpl->tpl_vars['BANNER']->value;?>
...
"><?php echo $_smarty_tpl->tpl_vars['post']->value['nickname'];?>
                            ...
                            <div class="metadata">
                                <span class="date" data-toggle="tooltip"
                                    data-content="<?php echo $_smarty_tpl->tpl_vars['post']->value['date'];?>
...
echo $_smarty_tpl->tpl_vars['post']->value['reactions_link'];
                                    ...
                                    <?php if ((smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['post']->value['reactions']['count'],'/[^0-9]+/','') != 0)) {?>(<?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['post']->value['reactions']['count'],'/[^0-9]+/','');?>
)<?php }?></a>
                                <?php }?>
...
"><?php echo $_smarty_tpl->tpl_vars['EDIT']->value;?>
                                ...
                                <a
                                    onclick="if(confirm(confirmDelete)){$('#form-delete-post-<?php echo $_smarty_tpl->tpl_vars['post']->value['id'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['nickname'];?>
                                    ...
                                    <div class="metadata">
                                        <span class="date" data-toggle="tooltip"
                                            data-content="<?php echo $_smarty_tpl->tpl_vars['item']->value['time_full'];?>
...
">
                                        ...
                                        <a
                                            onclick="if(confirm(confirmDelete)){$('#form-delete-<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
').submit();}"><?php echo $_smarty_tpl->tpl_vars['DELETE']->value;?>
</a>
                                        <?php }?>
                                    </div>
...
?>
                    ...
                    <div class="item">
                        <i
                            class="middle aligned <?php if ($_smarty_tpl->tpl_vars['field']->value['type'] == 'date') {?>calendar alternate<?php } else { ?>dot circle<?php }?> icon"></i>
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['post']->value) {
$_smarty_tpl->tpl_vars['post']->do_else = false;
if (((isset($_smarty_tpl->tpl_vars['CAN_MODERATE']->value)) && $_smarty_tpl->tpl_vars['CAN_MODERATE']->value == 1) || $_smarty_tpl->tpl_vars['post']->value['self'] == 1) {?>
...
<?php }
if ((isset($_smarty_tpl->tpl_vars['LOGGED_IN_USER']->value))) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['banner']->value['active'] == true) {?> selected<?php }?>>
                    <?php echo $_smarty_tpl->tpl_vars['banner']->value['name'];?>
</option>
                <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
